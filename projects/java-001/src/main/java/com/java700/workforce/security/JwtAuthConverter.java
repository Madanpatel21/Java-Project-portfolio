...
/**
 * Maps JWT claims to authorities. Accepts roles from a flat "roles" claim (dev issuer)
 * or from the standard "realm_access.roles" claim (Keycloak) for local-profile federation.
 */
@Component
