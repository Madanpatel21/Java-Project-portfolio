...
/**
 * Propagates or generates the X-Correlation-Id header, binds it to the MDC so every
 * structured log line and audit entry carries it, and echoes it on the response.
 */
@Component
